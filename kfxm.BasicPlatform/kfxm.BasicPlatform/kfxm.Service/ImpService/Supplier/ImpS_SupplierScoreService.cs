...
namespace kfxms.ImpService.Supplier
{
    ...
    public class ImplS_SupplierScoreService : IS_SupplierScoreService
    {
        ...
        /// <returns></returns>
        public IEnumerable<S_SupplierScore> GetPageDate<T>(System.Linq.Expressions.Expression<Func<S_SupplierScore, bool>> where, int pageIndex, int pageSize, out int total, Common.OrderByHelper<S_SupplierScore, T> orderBy)
        {
            return IS_SupplierScoreRepository_.GetPageDate(where, pageIndex, pageSize, out total, orderBy);
        }
        ...
        /// <param name="Total">总条数</param>
        /// <returns></returns>
        public IEnumerable<S_SupplierScore> GetPageDate(System.Linq.Expressions.Expression<Func<S_SupplierScore, bool>> where, int pageIndex, int pageSize, out int total, params Common.OrderByHelper<S_SupplierScore>[] orderBy)
        {
            return IS_SupplierScoreRepository_.GetPageDate(where, pageIndex, pageSize, out total, orderBy);
        }
    }
