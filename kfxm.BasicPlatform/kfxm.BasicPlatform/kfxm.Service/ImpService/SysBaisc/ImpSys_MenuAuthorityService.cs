...
namespace kfxms.ImplService.SysBasic
{
    ...
    public class ImplSys_MenuAuthorityService : ISys_MenuAuthorityService
    {
        ...
        /// <returns></returns>
        public IEnumerable<Sys_MenuAuthority> GetPageData<T>(System.Linq.Expressions.Expression<Func<Sys_MenuAuthority, bool>> where, int pageIndex, int pageSize, out int total,Common.OrderByHelper<Sys_MenuAuthority,T> orderBy)
        {
            return ISys_MenuAuthorityRepository_.GetPageData(where, pageIndex, pageSize, out total, orderBy);
        }
        ...
        /// <param name="Total">总条数</param>
        /// <returns></returns>
        public IEnumerable<Sys_MenuAuthority> GetPageData(System.Linq.Expressions.Expression<Func<Sys_MenuAuthority, bool>> where, int pageIndex, int pageSize, out int total, params Common.OrderByHelper<Sys_MenuAuthority>[] orderBy)
        {
            return ISys_MenuAuthorityRepository_.GetPageData(where, pageIndex, pageSize, out total,orderBy);
        }
    }
